...
namespace Paybee.Gateway.Queue.Queue
{
    ...
    {  
        ...
        public QueueHelper()
        {
            ...
            Config.Add("bootstrap.servers", "kafka-3976c617.douglasdev-d721.aivencloud.com:18347");
           //Config.Add("group.id", "teste");
            Config.Add("security.protocol", "SSL");
            Config.Add("ssl.certificate.location", "/Users/douglassilva/Downloads/service.cert");
            Config.Add("ssl.key.location", "/Users/douglassilva/Downloads/service.key");

            Config.Add("ssl.ca.location", "/Users/douglassilva/Downloads/ca.pem");
